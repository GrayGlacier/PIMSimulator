...
vector<PIMCmd> PIMCmdGen::getPIMCmds(KernelType ktype, int bank_id, int num_q_embs,
                                    int num_jump_to_be_taken, int num_jump_to_be_taken_odd_bank, int num_jump_to_be_taken_even_bank)
{
    ...
    switch (ktype)
    {
        ...
        */
        ...
        case KernelType::GEMVTREE:
            ...
            break;
        case KernelType::EMB:
            pim_kernel = make_unique<EmbOpPIMKernelMultQ>(ktype, bank_id, num_q_embs);
            break;
        default:
...
vector<PIMCmd> PIMCmdGen::getPIMCmds(KernelType ktype, int bank_id, 
                                    int num_jump_to_be_taken, int num_jump_to_be_taken_odd_bank, int num_jump_to_be_taken_even_bank)
{
    unique_ptr<IPIMCmd> pim_kernel = nullptr;
    switch (ktype)
